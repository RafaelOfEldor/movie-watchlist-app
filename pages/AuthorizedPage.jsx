...
export default function LoginPage() {
    ...
    firestore.doc.map(item => {
      ...
      return (
      auth?.currentUser 
      ? <Outlet context={{movies, searchText, page, watchlistMovie, watchlistStateChangeCounter, 
        canScroll, setCanScroll, setWatchlistStateChangeCounter, setWatchlistMovie, setPage, currentUser, setCurrentUser}}/> 
      :  <Navigate to="/login"
