...
export default function HomePage() {
  ...
  const { movies,  searchText, watchlistMovie, watchlistStateChangeCounter, canScroll, setCanScroll, setWatchlistStateChangeCounter, setWatchlistMovie, page, setPage } = useOutletContext()
